...
- Software Engineering Intern @ Headstarter AI
- **OpenAI Internship Research** — frontier LLM development & evaluation
- LEO satellite collision avoidance simulator (**ORB**) with real TLE data
- IEEE INFOCOM 2022 replication — CCN in LEO satellite networks (Q-Learning RL backend, AnyLogic simulation)
...
**ML/AI:** PyTorch | TensorFlow | LangGraph | Transformers | LoRA | Inference Optimization  
**Data & Viz:** HuggingFace | AnyLogic | Matplotlib | D3.js  
**Research:** JWST data pipelines | Weak lensing analysis | Neural rendering  
**Backend:** Python | Node.js | FastAPI | SQL  
...
**Discord**: hohoorbitin  
*(DMs > emails for urgent stuff; I live on Discord)*
